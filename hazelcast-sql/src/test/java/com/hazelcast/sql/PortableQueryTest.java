...
public class PortableQueryTest extends HazelcastTestSupport {
    ...
    public boolean clusterHaveUserClassesAndPortableConfig;

    public TestHazelcastFactory factory = new TestHazelcastFactory();

    @Parameterized.Parameters(name = "inMemoryFormat:{0}, clusterHaveUserClassesAndPortableConfig:{1}")
    ...
    public void setup() {
        ...
        if (clusterHaveUserClassesAndPortableConfig) {
    ...
    public void testQueryOnObject() {
        ...
        assumeTrue(clusterHaveUserClassesAndPortableConfig);
        ClientConfig clientConfig = new ClientConfig();
