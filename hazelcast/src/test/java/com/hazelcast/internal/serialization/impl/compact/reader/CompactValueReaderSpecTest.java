...
public class CompactValueReaderSpecTest extends HazelcastTestSupport {
    ...
    public CompactValueReaderSpecTest(Object inputObject, Object expectedResult, String pathToRead, String parent) {
