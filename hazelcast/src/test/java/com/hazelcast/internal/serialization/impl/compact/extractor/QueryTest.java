...
public class QueryTest extends HazelcastTestSupport {
    ...
    public void testInMemoryFormatNotSupported_withoutClassConfig() {
    ...
    public void testIndexForComparableAttributes(IndexType indexType) throws IOException {
        ...
        for (Object value : result) {
            GenericRecord limbRecord = ((GenericRecord) value).readGenericRecord("firstLimb");
            assertEquals("left-hand", limbRecord.readUTF("name"));
        }
    }
}
