...
public interface InternalGenericRecord extends GenericRecord {
     ...
     */
    @Nullable
    LocalTime getNullableTimeFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    LocalDate getNullableDateFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    LocalDateTime getNullableTimestampFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    OffsetDateTime getNullableTimestampWithTimezoneFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    Character getNullableCharFromArray(@Nonnull String fieldName, int index);
