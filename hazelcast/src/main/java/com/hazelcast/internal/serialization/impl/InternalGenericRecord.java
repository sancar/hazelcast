...
public interface InternalGenericRecord extends GenericRecord {
     ...
     */
    @Nullable
    <T> T readObjectFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    BigInteger readBigIntegerFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    BigDecimal readBigDecimalFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    LocalTime readLocalTimeFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    LocalDate readLocalDateFromArray(@Nonnull String fieldName, int index);
     ...
     */
    @Nullable
    LocalDateTime readLocalDateTimeFromArray(@Nonnull String fieldName, int index);
