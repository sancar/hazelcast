...
public enum FieldType {
    ...
    NULLABLE_TIME(24, MAX_VALUE),
    NULLABLE_TIME_ARRAY(25, MAX_VALUE),
    DATE(26, SHORT_SIZE_IN_BYTES + BYTE_SIZE_IN_BYTES * 2),
    DATE_ARRAY(27, MAX_VALUE),
    NULLABLE_DATE(28, MAX_VALUE),
    NULLABLE_DATE_ARRAY(29, MAX_VALUE),
    TIMESTAMP(30, TIME.getTypeSize() + DATE.getTypeSize()),
    TIMESTAMP_ARRAY(31, MAX_VALUE),
    NULLABLE_TIMESTAMP(32, MAX_VALUE),
    NULLABLE_TIMESTAMP_ARRAY(33, MAX_VALUE),
    TIMESTAMP_WITH_TIMEZONE(34, TIMESTAMP.getTypeSize() + INT_SIZE_IN_BYTES),
    TIMESTAMP_WITH_TIMEZONE_ARRAY(35, MAX_VALUE),
    NULLABLE_TIMESTAMP_WITH_TIMEZONE(36, MAX_VALUE),
    NULLABLE_TIMESTAMP_WITH_TIMEZONE_ARRAY(37, MAX_VALUE),
    COMPOSED(38, MAX_VALUE),
    COMPOSED_ARRAY(39, MAX_VALUE),

    NULLABLE_BYTE(40, MAX_VALUE),
    NULLABLE_BYTE_ARRAY(41, MAX_VALUE),
    NULLABLE_BOOLEAN(42, MAX_VALUE),
    NULLABLE_BOOLEAN_ARRAY(43, MAX_VALUE),
    NULLABLE_CHAR(44, MAX_VALUE),
    NULLABLE_CHAR_ARRAY(45, MAX_VALUE),
    NULLABLE_SHORT(46, MAX_VALUE),
    NULLABLE_SHORT_ARRAY(47, MAX_VALUE),
    NULLABLE_INT(48, MAX_VALUE),
    NULLABLE_INT_ARRAY(49, MAX_VALUE),
    NULLABLE_LONG(50, MAX_VALUE),
    NULLABLE_LONG_ARRAY(51, MAX_VALUE),
    NULLABLE_FLOAT(52, MAX_VALUE),
    NULLABLE_FLOAT_ARRAY(53, MAX_VALUE),
    NULLABLE_DOUBLE(54, MAX_VALUE),
    NULLABLE_DOUBLE_ARRAY(55, MAX_VALUE);
